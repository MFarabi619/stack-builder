...
These projects served as excellent references for me to learn web development tooling + best practices.

<hr />

I found that they all have many things in common such as:
...
- [Husky](https://typicode.github.io/husky/) for [Git hooks](https://git-scm.com/docs/githooks)
