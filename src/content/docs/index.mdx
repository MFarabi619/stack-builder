...
Choosing ORMs, API layers, and Databases was where the real fun started, and the templates didn't really help with that. I needed something that would educate me on the pros and cons of each choice.
